    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='teacher_group', to='auth.group')),
                ('teachers', models.ManyToManyField(blank=True, related_name='teacher_colleagues', to='backend.teacher')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True)),
                ('name', models.CharField(max_length=255)),
                ('groups', models.ManyToManyField(blank=True, related_name='student_group', to='auth.group')),
                ('teachers', models.ManyToManyField(blank=True, related_name='student_teachers', to='backend.teacher')),
